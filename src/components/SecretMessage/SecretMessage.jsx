...
const SECRET_LINES = [
  'Це лише малееенька частинка всіх тих',
  'неймовірних моментів, які зробили мене щасливим 💕',
  '',
  'Тож у цей чарівний день і всі наступні',
  'дозволь не тільки побажати тобі такої ж радості,',
  'якою ти радуєш мене кожного дня! 😊',
  'А й зробити тебе щасливою',
  '',
  'Перш за все хочу, щоб ти завжди була в гарному настрої',
  'Тож до вашої уваги я підготував трішечки мемасиків',
  'які, сподіваюсь, піднімуть тобі настрій ще більше!',
  '',
              ...
              <div className="relative">
                ...
                <div className="relative bg-white dark:bg-rose-950/80 rounded-2xl shadow-2xl border border-rose-100 dark:border-rose-800 overflow-hidden">
                  ...
                  <div className="bg-gradient-to-r from-fuchsia-500 to-rose-500 px-6 py-4 flex items-center gap-3">
                    ...
                    <span className="text-white font-bold text-lg">Ооо Джул'єто з Днем Народження тебе ❤️</span>
